...
# Step 4: Calculate the total interconnector benefits
total_interconnector_sew <- sum(arup$SEW.bn.[arup$Interest.group == "Interconnector"])


# Step 7: For each Scenario and Country combination, recalculate the "Total" SEW.bn. value by summing the adjusted SEW.bn. values for "Consumer", "Producer", and "Interconnector"
...
# Step 8: Add an "Adjustment" column to both data frames
arup$Adjustment <- "Unadjusted"
adjusted_arup$Adjustment <- "Adjusted"

# Step 9: Merge the two data frames using rbind()
